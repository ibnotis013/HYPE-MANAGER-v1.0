...
public class Main {
    static void main() {
        ...
        Brand marca1 = new Brand("Nike", "Spain", 20);
        ...
        System.out.println(inventoryManager.findAnyBrand2("Nike"));

        System.out.println(calcularTotalValue(inventoryManager));
    }


    public static int calcularTotalValue(InventoryManager inventoryManager) {
        int suma = 0;
        for (Product product : inventoryManager.getProducts()) {
            suma += product.getBasePrice();
        }
        return suma;
    }
}